...
type UpdateStorePasswordFormProps = {
  storeId: number
}


const UpdatePasswordStoreForm = ({ storeId }: UpdateStorePasswordFormProps) => {
  ...
  const [{ data, loading, error }, updatePassword] = useAxios({ url: `/stores/${storeId}/password`, method: "PUT" }, { useCache: false, manual: true });
  ...
  return (
    <Card title="Cambiar contraseña de Tienda" titleWithBorder className={classes.marginB}>
...
export default UpdatePasswordStoreForm;
