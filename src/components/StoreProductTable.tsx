...
const StoreProductTable = ({ storeId }: any) => {
    ...
    return (
        <Card titleWithBorder title={<div className={classes.cardTitle}>
            <WidgetsOutlinedIcon ref={tableInitRef} className={classes.successText} />
